...
public class User {
	...
	//useful
	public User(int userId,String name, String username,  String email,String password, String phone, String address,String role) {
		super();
		this.userId = userId;
		this.name = name;
		this.username = username;
	...
	public String toString() {
		return "User [userId=" + userId + ", name=" + name + ", username=" + username + ", email=" + email+ ", password=" + password
				 + ", phone=" + phone + ", address=" + address + ", role=" + role + ", createdDate="
