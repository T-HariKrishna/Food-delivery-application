...
<div class="card-container">
    <% for(Menu menu: menuList) { %>
        <div class="card">
            ...
            <a  href="EditMenu?menuId=<%=menu.getMenuId()%>&restaurantName=<%= restaurantName%>"><center><button class="edit">Edit Menu</button></center></a>
            <a  href="DeleteMenu?menuId=<%=menu.getMenuId()%>"><center><button class="delete">Delete Menu</button></center></a>
        </div>
    <% } } else {%>
    <div class="empty-cart">
                <center><p>Your menu is empty. Please add some items to the menu.</p></center>
                
            </div>
        <% } %>
    <div class="card add-card">
			<a href="addMenuForm.jsp">Add New Menu</a>
		</div>
</div>
